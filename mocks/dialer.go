...
type Dialer struct {
	DialStub        func(context.Context) (cdc.Connection, error)
	dialMutex       sync.RWMutex
	dialArgsForCall []struct {
		arg1 context.Context
	}
	dialReturns struct {
		result1 cdc.Connection
		result2 error
	}
...
func (fake *Dialer) Dial(arg1 context.Context) (cdc.Connection, error) {
	fake.dialMutex.Lock()
...
func (fake *Dialer) DialCalls(stub func(context.Context) (cdc.Connection, error)) {
	fake.dialMutex.Lock()
	defer fake.dialMutex.Unlock()
	fake.DialStub = stub
}

func (fake *Dialer) DialArgsForCall(i int) context.Context {
	fake.dialMutex.RLock()
	defer fake.dialMutex.RUnlock()
...
func (fake *Dialer) DialReturns(result1 cdc.Connection, result2 error) {
	fake.dialMutex.Lock()
	defer fake.dialMutex.Unlock()
	fake.DialStub = nil
...
func (fake *Dialer) DialReturnsOnCall(i int, result1 cdc.Connection, result2 error) {
	fake.dialMutex.Lock()
	defer fake.dialMutex.Unlock()
	fake.DialStub = nil
